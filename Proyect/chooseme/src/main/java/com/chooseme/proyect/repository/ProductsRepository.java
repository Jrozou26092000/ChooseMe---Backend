...
public interface ProductsRepository extends CrudRepository<Products, Integer> {
	...
	@Query(value = 	"SELECT p.product_id, p.brand, p.name, p.created_at, p.active, p.photo, p.price, p.verified, p.reviewer_id, AVG(s.score) AS score FROM product_types as pt "
